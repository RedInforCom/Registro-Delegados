...
if (!isset($_SESSION['usuario_id']) || ($_SESSION['usuario_tipo'] != 'administrador' && $_SESSION['usuario_tipo'] != 'asesor')) {
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('¡Delegado creado exitosamente!'); window.location.href='../dashboard.php';</script>";
    } else {
        echo "<script>alert('Error al crear delegado. Intente nuevamente.'); window.location.href='../dashboard.php';</script>";
    }
