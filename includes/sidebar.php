<aside class="bg-gradient-to-b from-purple-700 to-purple-900 w-64 min-h-screen fixed left-0 top-0 z-20 shadow-2xl">
    ...
    <nav class="px-4">
        ...
        <button onclick="confirmarLimpiarBD()" class="w-full flex items-center px-4 py-3 text-white bg-red-600 hover:bg-red-700 rounded-lg mb-2 transition duration-300">
